...
class Game():
	def __init__(self):
		...
		self.font = pg.font.Font("jogo/fonts/game_over.ttf", 50)#fonte
		...
		self.restart_msg = self.font.render('Press I to restart', False, BLACK)
	...
	def drawGameOver(self):
		...
		display.blit(self.salvar_msg,(self.salvar_msg_x, DISP_H/2 + 30))
